...
public class TicketController {
    ...
    public ResponseEntity<?> assignTechnician(
        ...
        Ticket updated = ticketService.assignTechnician(id, technician);
        if (updated == null) {
            return new ResponseEntity<>("Ticket not found", HttpStatus.NOT_FOUND);
        }
        return new ResponseEntity<>(ticketService.convertToDTO(updated), HttpStatus.OK);
    ...
    public ResponseEntity<?> addComment(
        ...
        Ticket updated = ticketService.addComment(id, userId, userRole, comment);
        if (updated == null) {
            return new ResponseEntity<>("Ticket not found", HttpStatus.NOT_FOUND);
        }
        return new ResponseEntity<>(ticketService.convertToDTO(updated), HttpStatus.OK);
    ...
    public ResponseEntity<?> deleteComment(
        ...
        boolean deleted = ticketService.deleteComment(ticketId, commentId, userId);
        if (!deleted) {
